<script lang="ts">
  import { Card, ContextButton, Overlay } from "@kahi-ui/framework";

  export let logic_id: string;
</script>

<Overlay class="imprint-overlay" {logic_id} loading="lazy" captive>
    ...
    <div class="scrollable-imprint-card">
      ...
      <Card.Section>
        ...
        <p>
          ...
          E-Mail: raytracer at mrjakob . de
        </p>
        <p>
          ...
          wir diese Inhalte umgehend entfernen.<br /><br /><strong
          ...
          Links umgehend entfernen.<br /><br /><strong>Urheberrecht</strong><br
          /><br />
...
<style>
  ...
  :global(.imprint-overlay) {
    z-index: 300;
  }
  .scrollable-imprint-card {
    overflow: auto;
    padding: 6px 18px 24px 18px;
  }

  .scrollable-imprint-card :global(section) {
    margin-top: 18px;
  }

  .scrollable-imprint-card :global(p) {
    margin-top: 14px;
  }
</style>
